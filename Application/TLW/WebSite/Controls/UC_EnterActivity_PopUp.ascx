<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_EnterActivity_PopUp.ascx.cs"
...
<div id="divWin" class="fixed" style="left: 250px; top: 150px; width: 500px; z-index: 1000;
    display: none;">
                                            ...
                                            <center>
                                                ...
                                                <table class="tblItems" style="background-color: White;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox runat="server" ID="textIntroduction" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
