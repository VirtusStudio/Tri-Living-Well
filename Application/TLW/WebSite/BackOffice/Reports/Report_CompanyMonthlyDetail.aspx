<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/BackOffice.master" 
  CodeFile="Report_CompanyMonthlyDetail.aspx.cs" Inherits="Report_CompanyMonthlyDetail" Title="Monthly details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <table><tr>
        ...
        </table><div class="title" style="text-align:left;"> 
...
<tr>
    ...
    <td>
            <telerik:RadChart ID="RadChart_PAL_Average_MET" runat="server" SkinsOverrideStyles="false" Width="300" Height="275" Skin="Classic">
                <ChartTitle Visible="True">
                    <TextBlock Text="Average MET/PAL:"></TextBlock>
                </ChartTitle>
                <Series>
                    <telerik:ChartSeries Name="Average MET/PAL" Type="Bar">
...
<tr>
    <td>
            <telerik:RadChart ID="RadChart_PAL_Type" runat="server" SkinsOverrideStyles="false" Width="425" Height="375" Skin="Classic">
                <ChartTitle Visible="True">
    ...
    <td>
            <telerik:RadChart ID="RadChart_PAL_Time" runat="server" SkinsOverrideStyles="false" Width="425" Height="375" Skin="Classic">
                <ChartTitle Visible="True">
...
<tr>
    <td>
            <telerik:RadChart ID="RadChart_PAL_Duration" runat="server" SkinsOverrideStyles="false" Width="425" Height="375" Skin="Classic">
                <ChartTitle Visible="True">
    ...
    <td>
            <telerik:RadChart ID="RadChart_PAL_Intensity" runat="server" SkinsOverrideStyles="false" Width="425" Height="375" Skin="Classic">
                <ChartTitle Visible="True">
                ...
                <PlotArea>
                    ...
                    <YAxis AutoScale="True" >
                        <AxisLabel Visible="False" TextBlock-Text=""></AxisLabel>
                    </YAxis>
                </PlotArea>
            </telerik:RadChart>
    </td>
...
<tr>
    <td>
            <telerik:RadChart ID="RadChart_DD_Totals" runat="server" SkinsOverrideStyles="false" Width="850" Height="275" Skin="Classic">
                <ChartTitle Visible="True">
                    <TextBlock Text="Average Diatary Intake:"></TextBlock>
                </ChartTitle>
                <Series>
                    <telerik:ChartSeries Name="Type1" Type="Bar" >
                        <Appearance FillStyle-FillType="Solid"   FillStyle-MainColor="Maroon">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                    <telerik:ChartSeries Name="Type2" Type="Bar">
                        <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Blue">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                    <telerik:ChartSeries Name="Type3" Type="Bar">
                        <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Green">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                    <telerik:ChartSeries Name="Type4" Type="Bar">
                        <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Red">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                    <telerik:ChartSeries Name="Type5" Type="Bar">
                        <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Gray">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                    <telerik:ChartSeries Name="Type6" Type="Bar">
                        <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Black">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                    <telerik:ChartSeries Name="Type7" Type="Bar">
                        <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Orange">
                            <LabelAppearance Visible="True"></LabelAppearance>
                        </Appearance>
                    </telerik:ChartSeries>
                </Series>
                ...
                <PlotArea>
                    ...
                    <YAxis AutoScale="False" MinValue="0" MaxValue="20" Step="5">
                        <AxisLabel Visible="True" TextBlock-Text=""></AxisLabel>
                    </YAxis>
                </PlotArea>
            </telerik:RadChart>
...
<tr>
    <td>
        <table>
            <tr>
                <td>
                    <telerik:RadChart ID="RadChart_DD_LVTotals" runat="server" SkinsOverrideStyles="false" Width="300" Height="275" Skin="Classic">
                        <ChartTitle Visible="True">
                            <TextBlock Text="Average Life Value:"></TextBlock>
                        </ChartTitle>
                        <Series>
                            <telerik:ChartSeries Name="LVType1" Type="Bar">
                                <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Maroon">
                                    <LabelAppearance Visible="True"></LabelAppearance>
                                </Appearance>
                            </telerik:ChartSeries>
                            <telerik:ChartSeries Name="LVType2" Type="Bar">
                                <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Blue">
                                    <LabelAppearance Visible="True"></LabelAppearance>
                                </Appearance>
                            </telerik:ChartSeries>
                        ...
                        <PlotArea>
                            ...
                            <YAxis AutoScale="False"  MinValue="0" MaxValue="5" Step="1">
                                <AxisLabel Visible="True" TextBlock-Text=""></AxisLabel>
                            </YAxis>
                        </PlotArea>
                    </telerik:RadChart>
                ...
                <td>
                    <telerik:RadChart ID="RadChart_DD_TotalsCount" runat="server" SkinsOverrideStyles="false" Width="250" Height="275" Skin="Classic">
                        <ChartTitle Visible="True">
                            <TextBlock Text="Total Daily Diary Enrties:"></TextBlock>
                        </ChartTitle>
                        <Series>
                            <telerik:ChartSeries Name="Count" Type="Bar">
                                <Appearance FillStyle-FillType="Solid"  FillStyle-MainColor="Maroon">
                                    <LabelAppearance Visible="True"></LabelAppearance>
                                </Appearance>
                            </telerik:ChartSeries>
                ...
                <AjaxSettings>
                    ...
                    <telerik:AjaxSetting AjaxControlID="btnMonth">
                        <UpdatedControls>
                            ...
                            <telerik:AjaxUpdatedControl ControlID="RadChart_DD_Totals" />
                            <telerik:AjaxUpdatedControl ControlID="RadChart_DD_LVTotals" />
                            <telerik:AjaxUpdatedControl ControlID="RadChart_DD_TotalsCount" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
