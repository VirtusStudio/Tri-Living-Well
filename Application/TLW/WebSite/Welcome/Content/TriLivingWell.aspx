<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TriLivingWell.aspx.cs" Inherits="About" %>
...
<script type="text/javascript">
    ...
    <div style="width:100%;">
                    ...
                    <tr>
                    <td>
                        <uc1:UC_TextArea ID="UC_TextArea1" runat="server" TEXTAREA_NAME="TriLivingWell_1" />
                    </td>
                    </tr>
                    </table>
                    </div> 
