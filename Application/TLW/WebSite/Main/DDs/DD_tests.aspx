<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DD.aspx.cs" Inherits="PAL_Recent" %>
...
<span class="subTitle">Daily Diary</span>
    ...
    <br />
        ...
        <asp:Label ID="txtBackDate" runat="server"></asp:Label>
        <asp:Label ID="txtForwardDate" runat="server"></asp:Label>
        <br />
