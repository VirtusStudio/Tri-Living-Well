<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyNutrition.aspx.cs" Inherits="MyNutrition" %>
...
<div style="text-align:right; padding-bottom:5px;">
    <asp:Label ID="lblDetailLevel" runat="server"></asp:Label> | <a href="../../Main/MyProgram/MyProgram.aspx">Switch to My Program</a>
</div>
    <div style="height:100%;">
        <table>
        <tr>
            <td>
                <div class="title">My Nutrition</div>
            </td>
