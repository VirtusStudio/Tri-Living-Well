<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PAL_TABSA.aspx.cs" Inherits="PAL_TABS" %>
...
<!--IFRAME HEIGHT STUFF-->
<script type="text/javascript">
var iframeName = "TAB_IFRAME_CONTENT";
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <tr>
            <td>
                <div class="title">Personal Activity Log</div>
            </td>
            <td style="">
        ...
        <div class="description">
            ...
            <iframe frameborder="0" name="TAB_IFRAME_CONTENT" id="TAB_IFRAME_CONTENT" class="IFRAME_CONTENT IFRAME_TAB" src=""></iframe>
        </div>
