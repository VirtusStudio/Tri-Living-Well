...
<html>
	...
	<body  style="margin:0px;border-width:0px;padding:4px;">
		...
		<script language="JavaScript">
			var OxOc825=["availWidth","availHeight","inp_target","sel_protocol","inp_src","inp_title","dialogArguments","href","value","title","target","returnValue"]; window.resizeTo(0x15e,0xd4) ; window.moveTo((screen[OxOc825[0x0]]-0x15e)/0x2,(screen[OxOc825[0x1]]-0xd4)/0x2) ;var inp_target=document.getElementById(OxOc825[0x2]);var sel_protocol=document.getElementById(OxOc825[0x3]);var inp_src=document.getElementById(OxOc825[0x4]);var inp_title=document.getElementById(OxOc825[0x5]);var obj=top[OxOc825[0x6]];if(obj){if(obj[OxOc825[0x7]]){ inp_src[OxOc825[0x8]]=obj[OxOc825[0x7]] ;} ;if(obj[OxOc825[0x9]]){ inp_title[OxOc825[0x8]]=obj[OxOc825[0x9]] ;} ;if(obj[OxOc825[0xa]]){ inp_target[OxOc825[0x8]]=obj[OxOc825[0xa]] ;} ;} ; function insert_link(){var arr= new Array(); arr[0x0]=inp_src[OxOc825[0x8]] ;if(inp_target[OxOc825[0x8]]){ arr[0x1]=inp_target[OxOc825[0x8]] ;} ;if(inp_title[OxOc825[0x8]]){ arr[0x2]=inp_title[OxOc825[0x8]] ;} ; top[OxOc825[0xb]]=arr ; top.close() ;}  ;
		</script>
