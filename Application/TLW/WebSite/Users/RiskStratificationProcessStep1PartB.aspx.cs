...
using System.Data;
public partial class Users_RiskStratificationProcessStep1PartB : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        AppLib.InsertVisitedSectionDetails("Risk Stratification Process Step 1 Part B");
    ...
    private void BindCMSText()
    {
        ...
        try
        {
            lblCMSText.Text = oTemplateLib.GetTemplateDetailsByTemplateTemplateName("RiskStratificationProcessFirstStepIntroductionPart2").TextAreaHTML;
        }
        catch { }
    ...
    {
        Response.Redirect(AppConfig.GetBaseSiteUrl() + "Users/RiskStratificationProcessStep1.aspx?id=" + Request.QueryString["id"].ToString(),true);
    }
