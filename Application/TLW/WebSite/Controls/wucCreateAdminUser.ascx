<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucCreateAdminUser.ascx.cs" Inherits="Controls_wucCreateAdminUser" %>
                                                                    ...
                                                                    <table class="tblItems">
                                                                        ...
                                                                        <tr style="height: 30px; vertical-align: middle; ">
                                                                            ...
                                                                            <td align="left">
                                                                                ...
                                                                                <asp:ListItem Text="Select Admin User Type" Value="0"></asp:ListItem>
                                                                                <asp:ListItem Value="3b3da90d-fe36-4967-9fb1-700c9ca59a5c" Text="Experts"></asp:ListItem>
                                                                                <asp:ListItem Value="0f14122a-48eb-4efa-a82f-198d99c79f5f" Text="Health Coach"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="ddlYourRole" Display="Dynamic"
                                                                                    CssClass="required" ErrorMessage="Please Select User Type." ValidationGroup="CreateUserWizard1" Operator="GreaterThan"
                                                    ...
                                                    <center>
                                                        ...
                                                        <table class="tblItems">
                                                            <tr style="height: 30px; vertical-align: middle;">
                                                                ...
                                                                <td>
                                                                <asp:Label ID="txtOrganization" runat="server" Text="Blue Grotto Technologies" MaxLength="100" Width="200px"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </center>
