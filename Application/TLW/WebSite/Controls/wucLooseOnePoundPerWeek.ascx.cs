...
public partial class Controls_wucLooseOnePoundPerWeek : System.Web.UI.UserControl
{
    #region Events
    ...
    protected void btnCalculate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            txtAdditionalMinuteAdded.Text = Math.Round(Convert.ToDecimal(Convert.ToDecimal(1750) / decResult)).ToString();
        }
        catch { }
