<%@ Page language="c#" CodeFile="privateinbox_MSY.aspx.cs" AutoEventWireup="True" Inherits="privateinbox" MasterPageFile="AspNetForumMaster.Master" %>
...
function hoverTransparency(sElementName)
{
	...
	<div class="location">
		...
		»
		<asp:Label ID="lblInbox" runat="server" EnableViewState="False" meta:resourcekey="lblInboxResource1">Personal messages - Inbox</asp:Label></b><div style="text-align:right; padding-right:35px;"><a href="privateinboxArchive.aspx">Archived Messages</a> </div></div>
...
<%--Commented by Netsmartz for resolving compile time issues
                                          <telerik:RadGrid id="RadGrid1" runat="server" ShowHeader="False" Width="800" AutoGenerateColumns="False" Skin="na" BorderWidth="0px" GridLines="None" OnNeedDataSource="RadGrid1_NeedDataSource" OnDetailTableDataBind="RadGrid1_DetailTableDataBind">
                                               <mastertableview DataKeyNames="MessageGroupID">         
                                                    <Columns>
                                                            <telerik:GridBoundColumn Visible="false" DataField="MessageID" UniqueName="MessageID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="UserName" UniqueName="UserName" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="Signature" UniqueName="Signature" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="CreationDate" UniqueName="CreationDate" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="Subject" UniqueName="Subject" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="Body" UniqueName="Body" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="UserID" UniqueName="UserID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="FromUserID" UniqueName="FromUserID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="ToUserID" UniqueName="ToUserID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="MessageID" UniqueName="MessageID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="MessageGroupID" UniqueName="MessageGroupID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="NewMessageCount" UniqueName="NewMessageCount" ></telerik:GridBoundColumn>  
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="vertical-align:middle; color:Black; padding-left:5px; ">
                                                                         ...
                                                                         <td style="text-align:right;padding-right:5px;white-space:nowrap; width:100px; ">
                                                                           <div style="padding-bottom:5px"><a href="javascript:archiveMessage('<%# DataBinder.Eval(Container.DataItem, "MessageGroupID").ToString()%>');"><div style="color:Orange;">Archive Message</div></a></div>
                                                                           <div style="padding-bottom:5px"><a href="javascript:init();addComment('<%# DataBinder.Eval(Container.DataItem, "FromUserID").ToString()%>','<%# DataBinder.Eval(Container.DataItem, "ToUserID").ToString()%>','<%# DataBinder.Eval(Container.DataItem, "MessageGroupID").ToString()%>');"><div style="color:Blue;">Add Comment</div></a></div>
                                                                           <a href="mailto:<%# DataBinder.Eval(Container.DataItem, "USERNAME").ToString()%>?subject=Reference Code"><div style="color:Blue;">Send eMail</div></a>
                                                                        </td>
                                                                    </tr>
                                                                    </table>    
                                                                </div>                                    
                                                    ...
                                                    <DetailTables>
                                                        <telerik:GridTableView ShowHeader="False" AllowSorting="False" Width="100%" runat="server" NoDetailRecordsText="No Comments" ShowFooter="false">
                                                        <Columns>
                                                            <telerik:GridBoundColumn Visible="false" DataField="MessageID" UniqueName="MessageID" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="UserName" UniqueName="UserName" ></telerik:GridBoundColumn>  
                                                            <telerik:GridBoundColumn Visible="false" DataField="Signature" UniqueName="Signature" ></telerik:GridBoundColumn>  
             ...
             <center class="Round1"><center><center><center><center><center><center><center><center><center>
                    <table style="background-color:White;">
                        <tr>
                            ...
                            <td style="text-align:right;"><a class="aButton" href="javascript:bWaiting=false; hide('divAddComment'); hide('tag0');">Cancel</a></td></tr>
                    </table>
                    <br />
